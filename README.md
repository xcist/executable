...
[gecatsim_MacOS.exe](https://github.com/xcist/executable/raw/refs/heads/main/gecatsim_MacOS.exe?download=)

## Windows
Run `gecatsim_Windows.exe`. The input to this executable can only be `sim.py`, but its content can be modified for customized purposes. See the default `sim.py` for an example. 
